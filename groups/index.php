...
<?php include 'common/header.php'?>
        ...
        <div class="row gx-0 d-none d-lg-flex">
            <div class="col-lg-7 px-5 text-start">
                <div class="h-100 d-inline-flex align-items-center py-2 me-3">
                    <a class="text-body px-2" href="tel:+919754917683"><i class="fa fa-phone-alt text-primary me-2"></i>+919754917683</a>
                    <a class="text-body px-2" href="mailto:poddarsgroup.kamsp@gmail.com"><i class="fa fa-envelope-open text-primary me-2"></i>poddarsgroup.kamsp@gmail.com</a>
                </div>
            </div>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top py-lg-0 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
        <a href="index.html" class="navbar-brand ms-4 ms-lg-0">
            <h1 class="text-primary m-0"><img class="me-3"  width="100" src="img/logo1.png" alt="Icon">PoddarsGroup</h1>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <a href="contact.html" class="nav-item nav-link">Contact Us</a>
                  ...
                  <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu border-0 m-0">
                       <a href="complaint.html" class="dropdown-item">For Complaint</a>
                        <a href="complaint.html" class="dropdown-item">Help Line</a>
                    </div>
                </div>
            ...
            <a href="https://htmlcodex.com/downloading/?item=2328" class="btn btn-primary py-2 px-4 d-none d-lg-block">Sign In / Register</a>
        </div>
    </nav>
    <!-- Navbar End -->
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item d-flex position-relative text-center h-100">
                        ...
                        <div class="service-text p-5">
                            ...
                            <h3 class="mb-3">Consult with us on Marketing or Sell</h3>
                            <p class="mb-4">With years of experience, our staff has the capabilities and expertise to take your business to the next level. At poddarsgroup.kamsp.</p>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item d-flex position-relative text-center h-100">
                        ...
                        <div class="service-text p-5">
                            ...
                            <h3 class="mb-3">Contact us to sell your Build.Materials</h3>
                            <p class="mb-4">Any type of need of building material,Consult about selling ur Material and Products to us.</p>
                            <a class="btn" href=""><i class="fa fa-plus text-primary me-3"></i>Read More</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item d-flex position-relative text-center h-100">
                        ...
                        <div class="service-text p-5">
                            ...
                            <h3 class="mb-3">Strategic Planning Session</h3>
                            <p class="mb-4">Come to talk us about to increase your business.</p>
                            <a class="btn" href=""><i class="fa fa-plus text-primary me-3"></i>Read More</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item d-flex position-relative text-center h-100">
                        ...
                        <div class="service-text p-5">
                            ...
                            <h3 class="mb-3">Register Labourer</h3>
                            <p class="mb-4">This service for a lobour Any labor/Any worker can register & get work withus..</p>
                            <a class="btn" href=""><i class="fa fa-plus text-primary me-3"></i>Read More</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item d-flex position-relative text-center h-100">
                        ...
                        <div class="service-text p-5">
                            ...
                            <h3 class="mb-3">Contact us,If Need a labour, build.works</h3>
                            <p class="mb-4">Need a labour for any type of building works, contact and register with us.</p>
                            <a class="btn" href=""><i class="fa fa-plus text-primary me-3"></i>Read More</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item d-flex position-relative text-center h-100">
                        ...
                        <div class="service-text p-5">
                            <img class="mb-4" src="img/icons/icon-10.png" alt="Icon">
                            <h3 class="mb-3">Building Contract</h3>
                            <p class="mb-4">Now build your own house according to you at minimum cost. Free consultation on helpline.</p>
                            <a class="btn" href=""><i class="fa fa-plus text-primary me-3"></i>Read More</a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-12">
                            <div class="d-flex">
                                ...
                                <div class="ms-4">
                                    ...
                                    <h3 class="mb-0">poddarsgroup.kamsp@gmail.com</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12 col-sm-6">
                            <select class="form-select" style="height: 55px;">
                                ...
                                <option value="2">House Renovation all work</option>
                                <option value="3">Building Materials</option>
                                <option value="3">Worker Registration</option>
                                <option value="3">Hire Labour & Engineers</option>
                            </select>
                        </div>
                        <div class="col-12 col-sm-6">
